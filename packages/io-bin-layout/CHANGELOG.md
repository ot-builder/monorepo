...
- Bump @ot-builder/ot-encoding to v1.8.0
- Bump @ot-builder/io-bin-encoding to v1.8.0
...
- Bump @ot-builder/io-bin-encoding to v1.7.9
...
- Bump @ot-builder/io-bin-glyph-store to v1.7.8
- Bump @ot-builder/io-bin-metadata to v1.7.8
- Bump @ot-builder/ot-encoding to v1.7.8
- Bump @ot-builder/io-bin-encoding to v1.7.8
...
- Bump @ot-builder/bin-composite-types to v1.7.6
- Bump @ot-builder/bin-util to v1.7.6
- Bump @ot-builder/ot-glyphs to v1.7.6
- Bump @ot-builder/ot-layout to v1.7.6
...
- Bump @ot-builder/ot-encoding to v1.7.6
- Bump @ot-builder/io-bin-encoding to v1.7.6
...
- Bump @ot-builder/bin-composite-types to v1.7.5
...
- Bump @ot-builder/bin-composite-types to v1.7.4
...
- Bump @ot-builder/bin-composite-types to v1.7.3
...
- Bump @ot-builder/bin-composite-types to v1.7.1
...
- Consider whether a lookup is used as dependency when writing lookups (otbbuilder-dev@users.noreply.github.com)
...
- Bump @ot-builder/io-bin-layout to v1.1.0 (otbbuilder-dev@users.noreply.github.com)
...
- Bump @ot-builder/io-bin-layout to v1.0.10 (otbbuilder-dev@users.noreply.github.com)
...
- Bump @ot-builder/io-bin-layout to v1.0.9 (otbbuilder-dev@users.noreply.github.com)
...
Wed, 30 Dec 2020 06:40:38 GMT

### Patches

- GPOS: Fix base filtering when writing mark-related lookups. (belleve@typeof.net)
...
- Fix max classdef item size: it should be 3 words instead of 2. (belleve@typeof.net)
...
- Avoid contextual lookups to be hidden behind extensions (belleve@typeof.net)
...
- Add post-read procedure for ligature carets for point-attached lig carets (type 2) (belleve@typeof.net)
- fix GDEF LigCaretList read & write (c@cyano.cn)
...
- OTL: Simplify classdef-related implementations (belleve@typeof.net)
