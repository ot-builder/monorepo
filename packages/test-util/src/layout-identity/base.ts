...
const testMinMaxTable = StdCompare((bim: EmptyCtx, a: Base.MinMaxTable, b: Base.MinMaxTable) => {
    testMinMaxValue(bim, a.defaultMinMax, b.defaultMinMax);
});

const testMinMaxValue = StdCompare((bim: EmptyCtx, a: Base.MinMaxValue, b: Base.MinMaxValue) => {
