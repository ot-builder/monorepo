...
### Interface <Decl s={Rectify.GlyphRectifier}/>

#### Methods

* <Method s={Rectify.GlyphRectifier.glyph} args={{from:Ot.Glyph}} returns={either(null,undefined,Ot.Glyph)}/>

### Function <Fn long s={Rectify.rectifyFontGlyphs(extend("GS",Data.OrderStore(Ot.Glyph)))} args={{rec:annot(Rectify.GlyphRectifier,"The Rectifier"),font:annot(Ot.Font("GS"),"The font to process"),gsf:annot(Data.OrderStoreFactoryWithDefault(Ot.Glyph,"GS"),"Factory to create a glyph store")}} returns="void"/>
...
* <Method s={Rectify.AxisRectifier.axis} args={{from:Ot.Var.Axis}} returns={either(null,undefined,Ot.Fvar.Axis)}/>
