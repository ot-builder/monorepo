...
* <Method static long s={Ot.Gsub.Table.create} args={{
    scripts:optional(map(Tag,Ot.GsubGpos.Script)),
    features:optional(array(Ot.GsubGpos.Feature)),
    lookups:optional(array(Ot.GsubGpos.Lookup)),
    featureVariations:optional(Data.Maybe(Ot.GsubGpos.FeatureVariation)),
    }}/>
...
<R s={Ot.Gsub.Multiple}/> is structurally identical to <R s={Ot.Gsub.Alternate}/>. However their <code>acceptLookupAlgebra</code> implementation responds to different methods in the <R s={Ot.GsubGpos.LookupAlg}/>: <R s={Ot.Gsub.Multiple}/> responds to <code>gsubMulti</code>, while <R s={Ot.Gsub.Alternate}/> responds to <code>gsubAlternate</code>.
...
<R s={Ot.Gsub.Alternate}/> is structurally identical to <R s={Ot.Gsub.Multiple}/>. However their <code>acceptLookupAlgebra</code> implementation responds to different methods in the <R s={Ot.GsubGpos.LookupAlg}/>: <R s={Ot.Gsub.Multiple}/> responds to <code>gsubMulti</code>, while <R s={Ot.Gsub.Alternate}/> responds to <code>gsubAlternate</code>.
...
<R s={Ot.Gsub.Chaining}/> is structurally identical to <R s={Ot.Gpos.Chaining}/>. However their <code>acceptLookupAlgebra</code> implementation responds to different methods in the <R s={Ot.GsubGpos.LookupAlg}/>: <R s={Ot.Gsub.Chaining}/> responds to <code>gsubChaining</code>, while <R s={Ot.Gpos.Chaining}/> responds to <code>gposChaining</code>.
...
<R s={Ot.Gpos.Chaining}/> is structurally identical to <R s={Ot.Gsub.Chaining}/>. However their <code>acceptLookupAlgebra</code> implementation responds to different methods in the <R s={Ot.GsubGpos.LookupAlg}/>: <R s={Ot.Gsub.Chaining}/> responds to <code>gsubChaining</code>, while <R s={Ot.Gpos.Chaining}/> responds to <code>gposChaining</code>.
