...
import { number, boolean, map, set, array, iterable, Data, Ot, Tag, Sigma, Thunk } from "api-doc/exports"
import { app, optional, tuple, readonly, pi, record } from "api-doc/tycon"
...
* <Method ctor long s={Ot.Gsub.Table.constructor} args={{
...
### Case Class <Decl s={Ot.Gsub.Single}/> | type = <R s={Ot.Gsub.LookupType.Single}/>
...
* <Method ctor s={Ot.Gsub.Single.Constructor} args={{props:optional(Ot.Gsub.SingleProp)}}/>
...
### Case Class <Decl s={Ot.Gsub.Multiple}/> | type = <R s={Ot.Gsub.LookupType.Multiple}/>
...
* <Method ctor s={Ot.Gsub.Multiple.Constructor} args={{props:optional(Ot.Gsub.MultipleAlternateProp)}}/>

### Case Class <Decl s={Ot.Gsub.Alternate}/> | type = <R s={Ot.Gsub.LookupType.Alternate}/>
...
* <Method ctor s={Ot.Gsub.Alternate.Constructor} args={{props:optional(Ot.Gsub.MultipleAlternateProp)}}/>
...
### Case Class <Decl s={Ot.Gsub.Ligature}/> | type = <R s={Ot.Gsub.LookupType.Ligature}/>
...
* <Method ctor s={Ot.Gsub.Ligature.Constructor} args={{props:optional(Ot.Gsub.LigatureProp)}}/>
...
### Case Class <Decl s={Ot.Gsub.Chaining}/> | type = <R s={Ot.Gsub.LookupType.Chaining}/>
...
* <Method ctor s={Ot.Gsub.Chaining.Constructor} args={{props:optional(Ot.GsubGpos.ChainingProp(Ot.Gsub.Lookup))}}/>

### Case Class <Decl s={Ot.Gsub.ReverseSub}/> | type = <R s={Ot.Gsub.LookupType.ReverseSub}/>
...
* <Method ctor s={Ot.Gsub.ReverseSub.Constructor} args={{props:optional(Ot.Gsub.ReverseSubProp)}}/>
...
* <Method ctor long s={Ot.Gpos.Table.constructor} args={{
...
### Case Class <Decl s={Ot.Gpos.Single}/> | type = <R s={Ot.Gpos.LookupType.Multiple}/>
...
* <Method ctor s={Ot.Gpos.Single.Constructor} args={{props:optional(Ot.Gpos.SingleProp)}} />
...
### Case Class <Decl s={Ot.Gpos.Pair}/> | type = <R s={Ot.Gpos.LookupType.Pair}/>
...
* <Method ctor s={Ot.Gpos.Pair.Constructor} args={{props:optional(Ot.Gpos.PairProp)}} />
...
### Case Class <Decl s={Ot.Gpos.Cursive}/> | type = <R s={Ot.Gpos.LookupType.Cursive}/>
...
* <Method ctor s={Ot.Gpos.Cursive.Constructor} args={{props:optional(Ot.Gpos.CursiveProp)}} />
...
### Case Class <Decl s={Ot.Gpos.MarkToBase}/> | type = <R s={Ot.Gpos.LookupType.MarkToBase}/>
...
* <Method ctor s={Ot.Gpos.MarkToBase.Constructor} args={{props:optional(Ot.Gpos.MarkToBaseProp)}} />
...
### Case Class <Decl s={Ot.Gpos.MarkToLigature}/> | type = <R s={Ot.Gpos.LookupType.MarkToLigature}/>
...
* <Method ctor s={Ot.Gpos.MarkToLigature.Constructor} args={{props:optional(Ot.Gpos.MarkToLigatureProp)}} />
...
### Case Class <Decl s={Ot.Gpos.MarkToMark}/> | type = <R s={Ot.Gpos.LookupType.MarkToMark}/>
...
* <Method ctor s={Ot.Gpos.MarkToMark.Constructor} args={{props:optional(Ot.Gpos.MarkToMarkProp)}} />
...
### Case Class <Decl s={Ot.Gpos.Chaining}/> | type = <R s={Ot.Gpos.LookupType.Chaining}/>
...
* <Method ctor s={Ot.Gpos.Chaining.Constructor} args={{props:optional(Ot.GsubGpos.ChainingProp(Ot.Gpos.Lookup))}}/>
...
### Datatype <Decl s={Ot.GsubGpos.FeatureParams.CharacterVariant}/>

#### Type ID

* <Decl s={Ot.GsubGpos.FeatureParams.TID_CharacterVariant}/>

#### Members

* <Member readonly s={Ot.GsubGpos.FeatureParams.CharacterVariant.featUiLabelNameId} type={number}/>
* <Member readonly s={Ot.GsubGpos.FeatureParams.CharacterVariant.featUiTooltipTextNameId} type={number}/>
* <Member readonly s={Ot.GsubGpos.FeatureParams.CharacterVariant.sampleTextNameId} type={number}/>
* <Member readonly s={Ot.GsubGpos.FeatureParams.CharacterVariant.numNamedParameters} type={number}/>
* <Member readonly s={Ot.GsubGpos.FeatureParams.CharacterVariant.firstParamUiLabelNameId} type={number}/>
* <Member readonly s={Ot.GsubGpos.FeatureParams.CharacterVariant.characters} type={readonly(array(number))}/>
...
* <Fn s={Ot.DicingStore.create} args={{rep:optional(Ot.DicingStoreRep("X","Y","D"))}} />
...
* <Method s={Ot.DicingStore.toRep} args={{}} returns={Ot.DicingStoreRep("X","Y","D")}/>

### Datatype <Decl s={Ot.DicingStoreRep("X","Y","D")}/>

#### Properties

* <Member s={Ot.DicingStoreRep.xClasses} type={array(array("X"))}/>
* <Member s={Ot.DicingStoreRep.yClasses} type={array(array("Y"))}/>
* <Member s={Ot.DicingStoreRep.data} type={array(array("D"))}/>