...
import { string, boolean, number, array, set, Ot, Data, Thunk, Caster } from "components/exports"
...
### Class <Decl s={Ot.ListGlyphStore} />
 ...
 * <Method s={Ot.Glyph.acceptGlyphAlgebra('E', 'EG', 'EH')} args={{alg:Ot.Glyph.GlyphAlg('E', 'EG', 'EH')}} returns="E"/>
 ...
 * <Method s={Ot.Glyph.Geometry.acceptGeometryAlgebra("E")} args={{alg: Ot.Glyph.GeometryAlg("E")}} returns="E"/>
...
### Class <Decl s={Ot.Glyph.ContourSet}/>

#### Type ID

 * <Decl s={Ot.Glyph.TID_ContourSet}/>
...
### Class <Decl s={Ot.Glyph.TtReference}/>

#### Type ID

 * <Decl s={Ot.Glyph.TID_TtReference}/>
...
### Class <Decl s={Ot.Glyph.GeometryList}/>

#### Type ID

 * <Decl s={Ot.Glyph.TID_GeometryList}/>
 ...
 * <Method s={Ot.Glyph.Hint.acceptHintAlgebra("E")} args={{alg:Ot.Glyph.HintAlg("E")}} returns="E"/>
...
### Class <Decl s={Ot.Glyph.TtInstructionHint} />

#### Type ID

 * <Decl s={Ot.Glyph.TID_TtInstructionHint}/>
...
### Class <Decl s={Ot.Glyph.CffHint} />

#### Type ID

 * <Decl s={Ot.Glyph.TID_CffHint}/>
