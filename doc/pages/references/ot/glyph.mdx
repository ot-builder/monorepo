...
### Case Type <Decl s={Ot.Glyph.ContourSet}/> | type = <R s={Ot.Glyph.GeometryType.ContourSet}/>
...
### Case Type <Decl s={Ot.Glyph.TtReference}/> | type = <R s={Ot.Glyph.GeometryType.TtReference}/>
...
### Type <Decl s={Ot.Glyph.TtInstruction} /> | type = <R s={Ot.Glyph.HintType.TtInstruction}/>
...
#### Factory Methods
 * <Fn s={Ot.Glyph.TtInstruction.create} args={{instructions:"Buffer"}} />
...
### Type <Decl s={Ot.Glyph.CffHint} /> | type = <R s={Ot.Glyph.HintType.CffHint}/>
