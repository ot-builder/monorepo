...
### Type <Decl s={Ot.Var.Dim} />

An object type representing a “variation dimension” in a vaiable font. Its object identity is significant, and is used to distinguish dimensions of a variable font's deisgn space.
