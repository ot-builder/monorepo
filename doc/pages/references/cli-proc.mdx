...
### Function <Fn s={CliProc.mergeFont(extend("GS1", Ot.GlyphStore),extend("GS2", Ot.GlyphStore))} args={{basis:Ot.Font("GS1"),override:Ot.Font("GS2"),gsf:Ot.GlyphstoreFactory("GS1"),options:optional(CliProc.MergeOptions)}}/>
