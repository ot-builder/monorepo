...
* <Item optional s={FontIo.FontIoConfig.ttf}/>:
    ...
    * <Member optional s={FontIo.FontIoConfig.ttf.gvarForceProduceTvd} type={boolean} />

        When building `gvar`, force production of tuple variation data, even if the glyph has no variation.
