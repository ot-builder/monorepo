...
* <Item optional s={FontIo.FontIoConfig.ttf}/>:
    ...
    * <Member optional s={FontIo.FontIoConfig.ttf.glyfIncludeOverlapSimpleFlag} type={boolean} />

        Whether to include `OVERLAP_SIMPLE` flag in `glyf` table. Defaults to `true`.
